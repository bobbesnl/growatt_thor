...
class LastSessionState:
    ...
    effective_charging_minutes: float | None = None
    ...
    def from_dict(cls, value: Any) -> "LastSessionState":
        ...
        return cls(
            ...
            effective_charging_minutes=_optional_float(
                data.get("effective_charging_minutes")
            ),
    ...
    def as_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "effective_charging_minutes": self.effective_charging_minutes,
